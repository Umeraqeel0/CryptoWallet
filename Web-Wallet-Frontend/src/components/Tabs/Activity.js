                ...
                >
                    ...
                    <DialogContent sx={{ width: '330px' }}>
                        <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                            <p>Status</p>
                            <p>
                                <a href="your-link-here" style={{ color: 'blue' }}>View on explorer</a>
                            </p>
                        </div>
                        <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '-28px' }}>
                            <p style={{ color: 'green' }}>Confirmed</p>
                            <p style={{ color: 'blue' }}>Copy transaction ID
                            </p>
                        </div>
                        ...
                        <div style={{ display: 'flex', alignItems: 'center', marginTop: '-22px' }}>
                            <img src={round} alt="Image Description" style={{ width: '23px', height: '23px', marginLeft: '1px' }} />
                            <p style={{ color: 'black', marginLeft: '10px' }}>0x..fc5</p>
                            <img src={right} alt="Image Description" style={{ width: '33px', height: '33px', marginLeft: '40px' }} />
                            <img src={round} alt="Image Description" style={{ width: '23px', height: '23px', marginLeft: '50px' }} />
